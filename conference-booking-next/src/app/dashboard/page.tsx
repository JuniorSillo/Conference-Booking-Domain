      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 border-r border-white/5 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <blockquote className="text-3xl font-light text-white/90 leading-snug tracking-tight">
            "Book the right room,<br />
            <span className="text-indigo-400 font-normal">exactly when your meeting begins."</span>
          </blockquote>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-zinc-700 flex items-center justify-center text-xs text-white/60 font-medium">JS</div>
            <div>
